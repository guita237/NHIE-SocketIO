...
3. Port for Backend is now `localhost:3500`
...
The API is accessible at `localhost:3500/`.
...
The SocketIO is accessible at `localhost:5500/`. This provides methods `GET` und `POST`.
