...
// CORS pour les requêtes HTTP normales
app.use(
    cors({
...
export const initializeServer = async () => {
    ...
    if (process.env.NODE_ENV === "production") {
        console.log("NODE_ENV=production -> running migrations...");
        await DI.orm.getMigrator().up();
        console.log("Migrations applied successfully");
    } else {
        console.log("Dev mode -> updating schema...");
...
// Nur im normalen Modus starten (nicht im Test)
